...
*/
bool frame_handlefunc(ei_widget_t widge,
                      struct ei_event_t*	event);


static const ei_widgetclass_t ei_class_frame = {
    .name = "frame",
    .allocfunc = frame_allocfunc,
    .releasefunc = frame_releasefunc,
    .drawfunc = frame_drawfunc,
    .setdefaultsfunc = frame_setdefaultsfunc,
    .geomnotifyfunc = frame_geomnotifyfunc,
    .handlefunc = frame_handlefunc,
    NULL
};