...
//     // SOI
//     int16_t SOI_marker = 0xFFD8; // Marqueur SOI
//     writeword(SOI_marker);

//     // APP0
//     int16_t APP0_marker = 0xFFE0;            // Marqueur APP0
//     int16_t APP0_len = 16;                   // Longueur de la section
//     char APP0_versionhi, APP0_versionlo = 1; // Version JFIF
//     // Données spécifiques au JFIF, non traitées
//     char APP0_xyunits = 0;
...
//     writebyte('F');
//     writebyte(0);
//     writebyte(APP0_versionhi);
//     writebyte(APP0_versionlo);
...
//     // DQT
//     int16_t DQT_marker = 0xFFDB; // Marqueur DQT
//     // 4bits : Précision (0 : 8 bits, 1 : 16 bits)
//     // 4bits : Indice i_Q de la table de quantification
//     char DQT_QTYinfo = 0;
...
//     if (jpg->qtableC = NULL)
//     {
//         // Longueur de la section (2 + (1 + nb_valeurs de la table de quantification * précision)*nb_composants)
...
//     // SOF0
//     int32_t SOF0_height = jpeg_get_image_height(jpg);         // Hauteur en pixels de l'image
//     int32_t SOF0_width = jpeg_get_image_width(jpg);           // Largeur en pixels de l'image
//     uint8_t SOF0_nb_components = jpeg_get_nb_components(jpg); // Nombre de composantes N

//     int16_t SOF0_marker = 0xFFC0;                  // Marqueur SOF0
//     int16_t SOF0_len = 8 + SOF0_nb_components * 3; // Longueur de la section
//     char SOF0_precision = 8;                       // Précision en bits par composante
...
//     writebyte(jpg->SOF0info->IdY); // Identifiant de composante Y
//     // HVY : 4 bits : Facteur d'échantillonnage horizontal
//     //       4 bits : Facteur d'échantillonnage vertical
//     writebyte(jpg->SOF0info->HVY);
//     writebyte(jpg->SOF0info->QTY); // Table de quantification Y
//     // les images en couleur
...
//     int16_t DHT_marker = 0xFFC4; // Marqueur DHT
...
//     int16_t DHT_len; // Longueur de la section
//     // 3 bits : non utilisés, doit valoir 0
...
//     // Nombres de symboles avec des codes de longueur 1 à 16.
//     for (int i = 0; i < 16; i++)
//     {
...
//     // SOS
//     int16_t SOS_marker = 0xFFDA;                             // Marqueur SOS
//     uint8_t SOS_nb_components = jpeg_get_nb_components(jpg); // Nombre de composantes
//     int16_t SOS_len = 6 + 2 * SOS_nb_components;             // Longueur de la section
//     char SOS_IdY = 1;
//     char SOS_HTY = 0;
//     char SOS_IdCb = 2;
//     char SOS_HTCb = 0x11;
...
// {
//     int len = strlen(jpeg_filename_j);
//     jpg->jpeg_filename = malloc(sizeof(char *));
//     jpg->bitstream_j = bitstream_create(jpeg_filename_j);
//     jpg->jpeg_filename = jpeg_filename_j;
// }
...
// {
//     jpg->image_height = image_height_j;
// }
// struct jpeg;
// /*
...
// {
//     jpg->nb_components = nb_components_j;
// }
...
//     if (cc == Y && dir == H)
//     {
//         // décaler à gauche 4 bits pour le facteur d'échantillonnage horizontal
//         sampling_factor = sampling_factor << 4;
//         jpg->SOF0info->HVY = sampling_factor;
//     }
//     if (cc == Y && dir == V)
//     {
//         //  Facteur d'échantillonnage (sampling factor) vertical
//         jpg->SOF0info->HVY += sampling_factor;
//     }
//     if (cc == Cb && dir == H)
//     {
